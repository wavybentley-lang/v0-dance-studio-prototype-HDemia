  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden" style={{ background: "radial-gradient(ellipse at 70% 30%, #5C1535 0%, #3D0D26 50%, #250818 100%)" }}>
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/hdemia/heroimage.jpg')",
      ...
      <div className="relative z-10 ml-0 max-w-7xl px-4 pt-32 pb-24 text-left sm:px-6 sm:pt-36 sm:pb-28 lg:mx-auto lg:w-1/2 lg:px-8 lg:py-0">
        ...
        <p className="animate-fade-in-up animate-delay-200 mb-4 max-w-none text-base leading-relaxed font-light text-pretty text-white sm:text-lg lg:max-w-xl lg:text-xl">
          Danza Classica, Moderna, Contemporanea, Hip Hop, Latino Americano e Danza Aerea per bambini, ragazzi e adulti.
        </p>
        <p className="animate-fade-in-up animate-delay-200 mb-4 max-w-none text-base leading-relaxed font-light text-pretty text-white sm:text-lg lg:max-w-xl lg:text-xl">
          In HDemia Dance Studio ogni allievo viene seguito da insegnanti qualificati in un ambiente professionale, accogliente e stimolante, dove la crescita artistica e personale camminano insieme.
        </p>
        <p className="animate-fade-in-up animate-delay-200 mb-4 max-w-none text-base leading-relaxed font-light text-pretty text-white sm:text-lg lg:max-w-xl lg:text-xl">
          Che tu stia muovendo i primi passi nel mondo della danza o desideri perfezionare la tua tecnica, troverai un percorso costruito per valorizzare il tuo talento e aiutarti a raggiungere i tuoi obiettivi.
        </p>
        <p className="animate-fade-in-up animate-delay-200 mb-10 max-w-none text-base leading-relaxed font-light text-pretty text-white sm:text-lg lg:max-w-xl lg:text-xl">
          Scopri i nostri corsi e prenota una lezione di prova.
        </p>
