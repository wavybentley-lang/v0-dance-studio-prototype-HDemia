...
const reviews = [
  ...
  },
  {
    ...
    time: "4 anni fa",
    text:
      "Hdemia dance è una vera e propria Accademia di insegnanti qualificati. Professionalità, serietà e gentilezza fanno di questa scuola una delle migliori in assoluto su tutto il territorio. Tra i vari corsi consiglierei quello di danza aerea. Davvero il top in tutto ",
  },
  {
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-14 px-4 text-left lg:px-0 lg:text-center">
          ...
          <p className="max-w-none text-lg text-pretty text-muted-foreground lg:mx-auto lg:max-w-2xl">
            Le parole di chi vive ogni giorno lesperienza Napoli Danza.
          </p>
        </div>
